...
class ASTModel(nn.Module):
    ...
    """
    def __init__(self, label_dim=527, fstride=32, tstride=8, input_fdim=256, input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=False, model_size='base384', verbose=True, mix_beta=None):
        ...
        if audioset_pretrain == False:
            ...
            new_proj = torch.nn.Conv2d(1, self.original_embedding_dim, kernel_size=(32, 8), stride=(fstride, tstride))
        ...
        # now load a model that is pretrained on both ImageNet and AudioSet
            ...
            audio_model = ASTModel(label_dim=527, fstride=32, tstride=8, input_fdim=256, input_tdim=1024, imagenet_pretrain=False, audioset_pretrain=False, model_size='base384', verbose=False)
            ...
            new_pos_embed = self.v.pos_embed[:, 2:, :].detach().reshape(1, 1024, 768).transpose(1, 2).reshape(1, 768, 8, 128)
    ...
    def get_shape(self, fstride, tstride, input_fdim=256, input_tdim=1024):
        ...
        test_proj = nn.Conv2d(1, self.original_embedding_dim, kernel_size=(32, 8), stride=(fstride, tstride))
    ...
    def forward(self, x, y=None, patch_mix=False, time_domain=False):
        ...
        h_patch, w_patch = (8, 128)  # kernel_size = (32, 8)
